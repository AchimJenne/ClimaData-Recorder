...
/*******************************************************************************
** The "begin()" function is overloaded
 to allow for variations in I2C and SPI initialization **
*******************************************************************************/
...
bool BME680_Class::begin(const uint32_t i2cSpeed, const uint8_t i2cAddress) {
  ...
  @details When called with a 32-bit parameter it is assumed that the I2C
           ...
           and the speed setting is determined by the parameter. If the 
           i2cAddress is 0 then check
